...
contract notas {
    ...
    function Evaluar(
        string memory _asignatura,
        string memory _idAlumno,
        uint256 _nota
    ) public UnicamenteProfesor(msg.sender) {
        // Hash de la identificacion del alumno
        bytes32 hash_idAlumno = keccak256(
            abi.encodePacked(_asignatura, _idAlumno)
        );
    ...
    function VerNotas(string memory _asignatura, string memory _idAlumno)
        public
        view
        returns (uint256)
    {
    ...
    function Revision(string memory _asignatura, string memory _idAlumno)
        public
    {
    ...
    function VerRevisiones(string memory _asignatura)
        public
        view
